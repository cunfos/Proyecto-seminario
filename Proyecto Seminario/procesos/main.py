...
#from procesos.interfaz_comunicacion.comunicacion_serial import ComunicacionSerial
...
class InterfazGraficaDeUsuario:
    ...
    def interfaz_registro(self):
        ...
        self.entrada_nombre.place(x=585, y=320)
        self.entrada_codigo_usuario = Entry(self.registro_window)
        self.entrada_codigo_usuario.place(x=585, y=475)
    ...
    def main(self):
        ...
        singup_button.place(x=987, y=578)
